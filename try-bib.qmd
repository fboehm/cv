...
```{python}
with open("bib2yaml/boehm.yaml", "r", encoding = 'utf-8') as file:
    data = yaml.load(file, Loader=yaml.SafeLoader)

with open("bib2yaml/old-boehm.yaml", "r", encoding = 'utf-8') as file:
    old_data = yaml.load(file, Loader=yaml.SafeLoader)

data["references"].extend(old_data["references"])
