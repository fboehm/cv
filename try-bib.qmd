    ...
    if (ref["type"] == ref_type): 
        ...
        if ref_type == "article-journal":  # need to have correct keys for each type!!
            ...
            if "volume" in ref:
                ...
                volume_issue = ""
            page = ref["page"]
            formatted_text = f"\\footnotesize {authors} ({date}). {title}. *{journal}* {volume_issue}:{page}. " + render_with_hyperlink("https://doi.org/" + doi) + f"\\footnotesize ."
